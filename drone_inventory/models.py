...
class DroneSchema(ma.Schema):
    class Meta:
        #detailing which fields to pull out of our drone and send to API call
...
# drone_1
# a_dict = {}
# for field in drone_schema.Meta.fields:
#     a_dict[field] = drone_1.field



    # take a python class object <x2982764582364928
